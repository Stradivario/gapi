## [1.8.215](https://github.com/Stradivario/gapi/compare/v1.8.28...v1.8.215) (2026-04-22)
...
* **gcli:** removed unused assignment to a wrong binary instead of native binaries now esbuild resolves automatically for which OS will be bundled ([191716a](https://github.com/Stradivario/gapi/commit/191716a8a08df3d0de71253c95e08cb2fc3831eb))
...
* **gcli:** wasm was not loaded correctly so we need to remove url since we are running in webcontainer ([6585092](https://github.com/Stradivario/gapi/commit/658509281b29e897b178c5f860dc0f06c8b01915))
